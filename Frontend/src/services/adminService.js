...
const updateCommunity = async (id, updates) => {
  const response = await api.put(`/api/admin/communities/${id}`, updates);
  return response.data;
};

const deleteCommunity = async (id) => {
  const response = await api.delete(`/api/admin/communities/${id}`);
  return response.data;
};
...
const updateListingAsAdmin = async (id, updates) => {
  const response = await api.put(`/api/admin/listings/${id}`, updates);
  return response.data;
};

const deleteListingAsAdmin = async (id) => {
  const response = await api.delete(`/api/admin/listings/${id}`);
  return response.data;
};
...
const updateProviderStatus = async (id, status) => {
  ...
  const response = await api.put(`/api/admin/providers/${id}/status?status=${status}`);
  return response.data;
};
